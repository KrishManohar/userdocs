...
cronscript () {
	...
	sed -i 's|# screen command|screen -dmS APPNAME npm start --prefix ~/.APPNAME|g' ~/.userdocs/cronjobs/$appname.cronjob
...
genericremove () {
    ...
    then
		...
		rm -rf ~/.userdocs/logs/node-forever.log
		#
		# nginx
