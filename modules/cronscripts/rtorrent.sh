#!/bin/bash
#
# Install command: wget -qO ~/autodlcron.sh https://git.io/vxyKo
#
# Crontab command: * * * * * bash -l ~/autodlcron.sh >> ~/.userdocs/cronjobs/logs/rtorrent.log 2>&1
#
...
#
# Lets make some required directories.
...
#
# The restart job for your rtorrent installation.
#
...
#
# The restart job for your autodl installation.
#
...
#
# Part 2: A cron based auto-patcher for an default installation of autodl.
#
